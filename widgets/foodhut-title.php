 ...
 * @since 1.0.0
 */
class Foodhut_Title extends Widget_Base {
	...
	public function get_title() {
		return __( 'Foodhut Title', 'foodhut-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'foodhut_title',
			[
				'label' => esc_html__( 'Foodhut Title', 'foodhut-core' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'EVENTS AT THE FOOD HUT', 'foodhut-core' ),
